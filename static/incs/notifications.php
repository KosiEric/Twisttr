<div class="container" id="notifis-container">
        ...
        <div class="col-md-5">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <span class="fa fa-bell"></span> News
              ...
              <img src="http://placehold.it/50/55C1E7/fff&text=JS" alt="User Avatar" class="img-circle" />
                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
                                    <strong class="primary-font">Jack Sparrow</strong> <small class="pull-right text-muted">
                                        <span class="fa fa-clock"></span>12 mins ago</small>
                                </div>
                                <p>
                        ...
                        <li class="right clearfix"><span class="chat-img pull-right">
                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
                                    <small class=" text-muted"><span class="fa fa-clock"></span>13 mins ago</small>
